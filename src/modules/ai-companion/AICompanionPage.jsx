...
export default function AICompanionPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full gap-5 select-none max-w-6xl mx-auto py-1">
      ...
      <section className="flex-1 w-full lg:w-[68%] flex flex-col justify-between bg-surface-container-lowest rounded-2xl shadow-sm border border-surface-container-high/40 p-4 sm:p-5 relative min-h-[560px]">
        {/* Chat Header */}
